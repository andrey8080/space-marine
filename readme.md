Лабы 1-3 находятся в соответвующих ветках сабмодулей. Во 2 лабе добавляется мультиимпорт с файла и транзакционность. В 3 лабе добавляется s3 и двухфазный коммит изменений
